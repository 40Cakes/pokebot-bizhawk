...
function GameSettings.initialize()
	...
	local pstats = {0x3004360, 0x20244EC, 0x2024284, 0x3004290, 0x2024190, 0x20241E4} -- Trainer stats
	local pcount = {0x3004350, 0x20244e9, 0x2024029} -- Party count # TODO missing Japan pointers
	...
	local trainerpointer = {0x3001FB4, 0x3005D90, 0x300500C, 0x3001F28, 0x3005AF0, 0x300504C} -- Trainer data
	local roamerpokemonoffset = {0x39D4, 0x4188, 0x4074, 0x39D4, 0x4188, 0x4074} -- Roamer Pokemon
